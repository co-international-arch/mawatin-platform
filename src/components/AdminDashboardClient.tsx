...
export function AdminDashboardClient({ stats, chartData }: { stats: any, chartData: any }) {
  return (
      ...
      <AnimatedWrapper delay={0}>
        <div className="flex items-center justify-between">
          <div>
            ...
            <p className="text-slate-500 mt-1">Suivez l'activité de la plateforme en temps réel (Données en direct).</p>
          </div>
        </div>
      </AnimatedWrapper>
      ...
      <FadeInStagger className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        ...
        <FadeInStaggerItem>
          <AppleCard className="p-6">
            ...
            <p className="text-3xl font-bold text-slate-900">{stats.activeArchitects}</p>
          </AppleCard>
        </FadeInStaggerItem>
        ...
        <FadeInStaggerItem>
          <AppleCard className="p-6">
            ...
            <p className="text-3xl font-bold text-slate-900">{stats.citiesCovered}</p>
          </AppleCard>
        </FadeInStaggerItem>
      </FadeInStagger>
      ...
      <AnimatedWrapper delay={0.2}>
        <AppleCard className="p-8">
          <div className="mb-8">
            ...
            <p className="text-sm text-slate-500">Volume de rapports générés.</p>
          </div>
